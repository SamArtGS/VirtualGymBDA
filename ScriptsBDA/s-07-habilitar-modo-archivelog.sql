...
alter system set log_archive_dest_1 = 'location=use_bd_recovery_file_des' scope = spfile;
alter system set log_archive_dest_2 = 'location=/configurar' scope = spfile;
